          ...
          >
            {author.profileImage ? (
              <div className="flex justify-center sm:justify-start">
                <div className="relative h-20 w-20 overflow-hidden rounded-full border border-border/60 bg-foreground/5 sm:h-40 sm:w-40">
                  <Image
            ...
            <CardHeader className="w-full px-0 pt-0 text-center sm:text-left">
              ...
              {author.bio ? (
                <CardDescription className="mt-1 text-xs text-foreground/70 sm:text-sm w-full">
                  {author.bio}
                </CardDescription>
              ) : null}
            </CardHeader>
